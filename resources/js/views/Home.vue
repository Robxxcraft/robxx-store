        ...
        <v-row wrap class="mx-1 my-4">
          <v-col cols="12" md="3" class="hidden-sm-and-down">
            <v-card class="rounded-lg" height="420" flat>
              <v-list>
                <template>
                  <v-card-title class="text-h6 grey--text text--darken-2"
                    >Recent Products</v-card-title
                  >
                  <div>
                    <v-list-item
                      v-for="(recent, index) in getRecentProducts"
                      :key="index"
                ...
                <v-row no-gutters class="hidden-md-and-up">
                  ...
                  <v-col cols="2">
                    <v-card
                      ...
                      <span class="white--text font-weight-bold subtitle-1">{{days}}</span>
                      <span
                        class="white--text font-weight-bold subtitle-2 ml-n1">d</span>
                    </v-card>
                  </v-col>
                  <v-col cols="2">
                    <v-card
                ...
                <v-carousel-item v-for="(product, index) in getSales" :key="index">
                  <v-list-item three-line>
                    ...
                    <v-list-item-content>
                      ...
                      <div>
                         Stock <span class="orange--text text--darken-2 font-weight-bold ml-3" >{{ product.stok }}</span>
                      </div>
                      <div>
                        Price <span class="orange--text text--darken-2 font-weight-bold ml-3">${{ product.price }}</span>
                      </div>
                    </v-list-item-content>
                  </v-list-item>
                  <v-card-text>
                      ...
                      <v-row>
                        ...
                        <v-col class="text-right">
                          <v-btn
                            ...
                            @click.prevent="addToCart(product)">Add To Cart</v-btn>
                        </v-col>
                      </v-row>
                    </v-card-actions>
                  </v-card-text>
          ...
          <v-col cols="12" md="3" class="text-center align-center justify-center my-5 hidden-md-and-up">
            ...
            <v-row wrap>
              <v-col cols="4" v-for="(category, index) in getHomeCategories" :key="index" style="padding: 0; margin: 0">
                <v-card color="orange" class="my-2 mx-2" elevation="3" :to="{ name: 'ProductsByCategory', params: { slug: category.slug }}" style="text-decoration: none" width="auto" height="120">
                  <v-card-subtitle>
                    <v-icon class="white--text">mdi-format-list-text</v-icon>
                  </v-card-subtitle>
                  <v-card-actions class="align-center justify-center">
                    <span class="white--text o font-weight-bold">{{category.name}}</span>
                  </v-card-actions>
                </v-card>
              </v-col>
              <v-col cols="4" style="padding: 0; margin: 0">
                <v-card
                  ...
                  <v-card-actions class="align-center justify-center">
                    <span class="white--text o font-weight-bold">More</span>
                  </v-card-actions>
                </v-card>
              </v-col>
            </v-row>
          ...
          <v-col cols="12" md="3">
            <v-card class="rounded-lg" height="590" flat>
              ...
              <v-card-text>
                <div class="text-h6 grey--text text--darken-2">Tags</div>
                <v-divider></v-divider>
                <div class="caption">
                  <v-chip
                    class="mx-1 my-1"
            ...
            <v-col class="my-auto" cols="12" md="6" lg="6" xl="6">
              ...
              <v-container class="mb-5">
                <span class="subtitle-1">Lorem ipsum dolor sit amet consectetur adipisicing elit.
                  ...
                  modi dolor nesciunt nam perferendis voluptatem!</span><br />
                <span class="subtitle-1">Lorem ipsum dolor sit amet consectetur adipisicing elit.
                  Voluptatum, similique. Ipsum eos iure consequatur illum quas
                  est, dolores, omnis magni officiis unde necessitatibus. Soluta
                  modi dolor nesciunt nam perferendis voluptatem!</span>
              </v-container>
            </v-col>
          </v-row>
        </v-card>
